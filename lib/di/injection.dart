...
import 'package:flutter_donate_app/data/repositories/product_repository_imp.dart';
...
void initializeDependencies() async {
  ...
  injector.registerLazySingleton<AddressRepository>(() => AddressRepositoryImp(remoteDataSource: injector()));
  injector.registerLazySingleton<ProductRepository>(() => ProductRepositoryImp(remoteDataSource: injector()));
